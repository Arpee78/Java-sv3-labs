...
public class PrimitiveTypesMain {
    ...
    public static void main(String[] args) {
        ...
        // e változó: a típusa legyen Integer, az értékét úgy add meg, hogy az Integer osztály
        // megfelelő metódusával hozz létre egy új Integer objektumot a 2-es számból!
        Integer e = Integer.valueOf(2);

        // f változó: a típusa legyen int, az értékét úgy add meg, hogy az Integer osztály
        // megfelelő metódusával hozz létre egy új Integer objektumot a 2-es számból!
        ...
        // i változó: a típusa legyen int, az értékét úgy add meg, hogy az Integer osztály
        // megfelelő metódusával hozz létre egy új int típusú értéket a "2" szövegből!
        int i = Integer.parseInt("2");

        // j változó: a típusa legyen Integer, az értékét úgy add meg, hogy az Integer osztály
        // megfelelő metódusával hozz létre egy új int típusú értéket a "2" szövegből!
        ...
        // hogy a Boolean osztály megfelelő metódusával hozz létre egy
        // új Boolean objektumot a true logikai literálból!
        ...
        // hogy a Boolean osztály megfelelő metódusával hozz létre egy
        // új boolean típusú értéket a "TrUe" szövegből!
        ...
        // hogy a Boolean osztály megfelelő metódusával hozz létre egy
        // új boolean típusú értéket a "TreU" szövegből!
